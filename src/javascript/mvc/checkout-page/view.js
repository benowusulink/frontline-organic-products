export class CheckoutView {
  constructor() {
    ...
    this.checkoutSection = document.getElementById(
    ...
    if (
      ...
      if (this.cartItems.length !== state.finalCheckoutItems.length) {
        ...
        if (newcartItems().length < 1) {
          ...
          this.checkoutButton = null;
          document
            .getElementById("checkout-page-main-section2-button")
            .remove();
          ...
          document.getElementById(
            "checkout-page-main-section2-span1",
          ).textContent = `Number of Products in Cart:
							${state.finalCheckoutItems.length}`;

          document.getElementById(
            "checkout-page-main-section2-span2",
